...
var wordList=["goku", "krillin", "vegeta", "trunks", "gohan", 
"naruto","luffy","yugi","kakashi","obito", "pikachu",
"all might","deku","ichigo","cell","sasuke","piccolo","frieza",
"alphonse","edward","gaara","ash","brock","misty"];
...
function checkUserInput(userInput) {
	...
	if(selectedWord.join("") === wordChoice) {
		...
		audioFile.src = "assets/audio/Sweet Victory.mp3";
      	audioFile.type = "mp3";
      	audioFile.play();
      	pickAWord();
    }
